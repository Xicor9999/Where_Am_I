    ...
    ball_chaser::DriveToTarget::Response& res)
{
    ...
    geometry_msgs::Twist motor_command_msg;

    // Set wheel velocities
    motor_command_msg.linear.x = req.linear_x;
    motor_command_msg.angular.z = req.angular_z;

    // Publish angles to drive the robot
    motor_command_publisher.publish(motor_command_msg);
